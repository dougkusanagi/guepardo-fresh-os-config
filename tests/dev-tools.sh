...
assert_contains "$ROOT_DIR/install-ubuntu/desktop/20-gnome-settings.sh" "dash-to-dock dash-max-icon-size 30"
...
assert_contains "$ROOT_DIR/install-fedora/desktop/20-gnome-settings.sh" "dash-to-dock dash-max-icon-size 30"
